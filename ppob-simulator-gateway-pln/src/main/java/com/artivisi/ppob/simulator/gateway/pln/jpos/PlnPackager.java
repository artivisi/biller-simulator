...
public class PlnPackager extends ISOBasePackager {
	...
	public PlnPackager() {
		...
		/* 004 */new IFA_NUMERIC(16, "Transaction Amount"),
		...
		/* 011 */new IFA_NUMERIC(12, "System Trace Audit Number"),
		/* 012 */new IFA_NUMERIC(14, "Date Time Local Transaction"),
		/* 013 */new IFA_NUMERIC(4, "DATE, LOCAL TRANSACTION"),
		/* 014 */new IFA_NUMERIC(4, "DATE, EXPIRATION"),
		/* 015 */new IFA_NUMERIC(8, "Date Settlement"),
		...
		/* 026 */new IFA_NUMERIC(4, "Merchant Category Code"),
		...
		/* 032 */new IFA_LLCHAR(7, "Bank Code"),
		...
		/* 039 */new IFA_NUMERIC(4, "Response Code"),
		...
		/* 056 */new IFA_LLCHAR(99, "Original Data Element"),
